    ...
    drawDigit: function(context, xPos, mask, c) {
      switch (mask) {
        case "#":
          ...
          var d = Math.sqrt(
            (this.segmentDistance * this.segmentDistance) / 2.0
          );
          var e = d / 2.0;
        ...
        case ".":
          context.fillStyle =
            c === "#" || c === "." ? this.colorOn : this.colorOff;
          this.drawPoint(
            context,
            xPos,
        ...
        case ":":
          context.fillStyle =
            c === "#" || c === ":" ? this.colorOn : this.colorOff;
          var y =
            (this.digitHeight - this.segmentWidth) / 2.0 - this.segmentWidth;
    ...
    getSegmentColor: function(c, charSet7, charSet14, charSet16) {
      if (c === "#") {
        ...
        switch (this.segmentCount) {
          ...
          case 16:
            var pattern =
              charSet14 + (charSet16 === undefined ? "" : charSet16);
